# xianyu-pilot-pro（闲鱼助手 · 商业版）

> ## 🚀 商业版已全面开源
>
> 原旧版开源项目 **xianyu-pilot 已停止维护**，其全部能力已迁移至本项目（商业版 **xianyu-pilot-pro**）并**全面开源**，同时进一步增强：
>
> - 🧩 **商业级滑块求解** — 三种模拟轨迹方案轮换、完全本地算法驱动、无需外部 API，实测本地成功率 70%+
> - 🔍 **商机挖掘** — 关键词 / 类目 / 对标店铺挖掘热门商品，一键改写 + 生图 + 发布
> - ⚙️ **工作流能力** — 工作流可视化编排、多账号批量铺货、定时发布、无人值守自动上架
>
> 旧版开源工程 [xianyu-pilot](https://github.com/dameng2026/xianyu-pilot) 仅供历史参考，**已不再维护**。
>
