...
public class ModuleCatalog {
    ...
    public ModuleCatalog() {
        ...
        add("plans", "套餐管理", "配置与用户前台 VIP 会员中心共用的套餐权益、限制、价格与上下架", cols("id:ID:80", "planName:套餐名称:160", "planCode:套餐编码:110", "price:价格:100", "durationDays:天数:90", "maxAccounts:账号数:100", "maxGoodsCount:商品数:100", "aiQuota:AI额度:110", "enableWorkflow:工作流:100:tag", "status:状态:100:tag"));
