...
public interface XianyuAccountHealthSnapshotMapper {
    ...
    @Insert("INSERT INTO xianyu_account_health_snapshot(tenant_id, account_id, health_score, api_success_rate, avg_response_ms, ws_latency_ms, collected_time, snapshot_time, deleted, created_time) " +
            "VALUES(#{tenantId}, #{accountId}, #{healthScore}, #{apiSuccessRate}, #{avgResponseMs}, #{wsLatencyMs}, #{collectedTime}, #{collectedTime}, 0, NOW())")
