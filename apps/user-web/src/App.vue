...
const pageMap = {
  ...
  'refund-cancel': asyncPage(() => import('./pages/RefundCancelPage.vue')),
  ...
  'fish-shop-browse': asyncPage(() => import('./pages/FishShopBrowsePage.vue')),
  ...
  'delivery-block-rules': asyncPage(() => import('./pages/DeliveryBlockRulesPage.vue')),
  ...
  'auto-reply-rules': asyncPage(() => import('./pages/AutoReplyRulesPage.vue')),
  'message-filters': asyncPage(() => import('./pages/MessageFiltersPage.vue')),
  'default-reply': asyncPage(() => import('./pages/DefaultReplyPage.vue')),
  blacklist: asyncPage(() => import('./pages/BlacklistPage.vue')),
