...
export function getCards(params = {}) {
  return request({ url: '/cards', method: 'get', params: pageParams(params) })
}
...
// ─── 卡密明细 ───
export function getCardItems(groupId, params = {}) {
  return request({ url: `/cards/${groupId}/items`, method: 'get', params: pageParams(params) })
}
...
// ─── 库存统计 ───
export function getCardStockStats(groupId) {
  return request({ url: `/cards/${groupId}/stats`, method: 'get' })
}
...
// ─── 使用记录 ───
export function getCardUsageRecords(groupId, params = {}) {
  return request({ url: `/cards/${groupId}/usage`, method: 'get', params: pageParams(params) })
}
...
// ─── 导入验证 ───
export function validateCardImport(data) {
  return request({ url: '/cards/import/validate', method: 'post', data })
}
