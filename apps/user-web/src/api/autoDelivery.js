...
// ─── 全店默认配置 ───
export function getGlobalDeliveryConfig() {
  return request({ url: '/auto-delivery/global-config', method: 'get' })
}

export function saveGlobalDeliveryConfig(data) {
  return request({ url: '/auto-delivery/global-config', method: 'put', data })
}
...
export function createDeliveryTemplate(data) {
  return request({ url: '/auto-delivery/templates', method: 'post', data })
}

export function updateDeliveryTemplate(id, data) {
  return request({ url: `/auto-delivery/templates/${id}`, method: 'put', data })
}

export function deleteDeliveryTemplate(id) {
  return request({ url: `/auto-delivery/templates/${id}`, method: 'delete' })
}

export function copyDeliveryTemplate(id) {
  return request({ url: `/auto-delivery/templates/${id}/copy`, method: 'post' })
}

export function getTemplateVariables() {
  return request({ url: '/auto-delivery/templates/variables', method: 'get' })
}

// ─── 发货记录 ───
export function getDeliveryRecords(params = {}) {
  return request({ url: '/auto-delivery/records', method: 'get', params: pageParams(params) })
}
...
export function getDeliverySourceGoods(id) {
  return request({ url: `/auto-delivery/sources/${id}/goods`, method: 'get' })
}

export function recommendDeliverySourceGoods(id) {
  return request({ url: `/auto-delivery/sources/${id}/recommend`, method: 'post' })
}
