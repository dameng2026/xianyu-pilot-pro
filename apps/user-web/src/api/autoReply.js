...
export function getAutoReplyLogs(params = {}) {
  return request({ url: '/auto-reply/rules/logs', method: 'get', params: pageParams(params) })
}

export function getAutoReplyStats(params = {}) {
  return request({ url: '/auto-reply/rules/stats', method: 'get', params })
}
