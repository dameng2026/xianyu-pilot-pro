export const navGroups = [
  ...
  { title: '自动化', items: [
    ...
    { key: 'workflow-drafts', label: '商品草稿箱', icon: 'draft', child: true },
    { key: 'workflow-image-records', label: '图片生成记录', icon: 'imageRecord', child: true },
    { key: 'auto-delivery', label: '自动发货', icon: 'truck' },
    { key: 'delivery-source-library', label: '货源库', icon: 'library', child: true },
    { key: 'delivery-statement', label: '发货声明', icon: 'statement', child: true },
