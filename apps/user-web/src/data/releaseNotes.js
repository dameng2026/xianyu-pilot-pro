...
export const releaseNotes = [
  {
    ...
    title: '货源商城、滑块多策略与发布草稿守卫',
    summary: '新增货源商城页一站式采购虚拟商品，滑块求解新增贝塞尔与微步拖动策略，发布商品页支持草稿自动保存与恢复，使用手册配齐全功能截图。',
    changes: [
      {
        label: '新增',
        items: [
          ...
          '使用手册页面配齐 24 张全功能截图，覆盖仪表盘、商品、订单、消息、发货、工作流等模块'
        ]
      },
      {
        label: '优化',
        items: [
          '滑块求解新增三次贝塞尔曲线拖动与小步匀加速拖动两种拟人策略，Y 轴抖动收窄至 ±3px 降低风控识别',
          '滑块求解重试调制改为按轮次循环（精确 / 略超 / 略欠），支持多轮重试持续优化命中',
      ...
      },
      {
        label: '修复',
        items: [
          '修复生产环境 automation 服务因缺失 JWT_SECRET 配置导致启动失败的问题',
          '修复生产环境上传卷权限归属 root 导致 app 用户无法写入、服务拒绝启动的问题'
        ]
      }
    ]
  },
  {
    ...
    summary: '滑块求解新增指数退避与账号代理绑定提升成功率，新增使用手册页面，自动分类与求解记录详情体验优化。',
    changes: [
      {
        label: '新增',
        items: [
