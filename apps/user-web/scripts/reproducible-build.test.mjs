...
function runBuild() {
  // npm exposes the exact CLI entry point to lifecycle scripts. Running that
  // JavaScript file with the current Node binary avoids Windows .cmd spawning
  // failures in workspaces whose absolute path contains non-ASCII characters.
