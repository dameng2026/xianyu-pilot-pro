    ...
    >
      ...
      <div class="flex-c gap-2.5">
        ...
        <button
          ...
          class="flex-cb w-40 h-9 px-2.5 c-p bg-transparent border border-g-400 rounded-custom-sm max-md:!hidden"
        ...
        >
          ...
          <span class="flex-c h-5 px-1.5 text-g-500/80 border border-g-400 rounded" aria-hidden="true">
        ...
        >
          <ArtIconButton icon="ri:translate-2" label="切换界面语言" class="language-btn text-[19px]" />
          <template #dropdown>
            <ElDropdownMenu>
        ...
        <ArtIconButton
          ...
          :label="showNotice ? '关闭通知中心' : '打开通知中心'"
...
<script setup lang="ts">
  ...
  onMounted(() => {
    initLanguage()
    // The onboarding popover is too noisy for day-to-day admin operation pages.
