...
<script setup lang="ts">
  ...
  /** 定时检查粒子状态，自动隐藏 canvas */
  const { pause: pauseParticleCheck, resume: resumeParticleCheck } = useIntervalFn(() => {
    if (canvasVisible.value && fireworkSystem.getActiveParticleCount() === 0) {
