...
<script setup lang="ts">
  ...
  const handlerLabel = computed(() => props.value
    ? props.successText
    : `${props.text}，按回车或空格键完成验证`)
  ...
  /**
   * Provide an equivalent keyboard path for users who cannot perform a pointer drag.
   * This client-side interaction is an accessibility affordance, not a security boundary.
   */
